...
public class ChunkProviderDeath implements IChunkProvider {
    ...
    public ChunkProviderDeath(World par1World, long par2, boolean par4, Block baseBlock)
    {
    ...
    /**
     * Will return back a chunk, if it doesn't exist and it's not an MP client, it will generates all the blocks for the
